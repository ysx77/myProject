...
<STYLE type=text/css>.STYLE1 {
  ...
  <body>
<form action="admin/gqproduct.jsp?f=f" method="post">
	<%
	 String sql = "select * from gqproduct where 1=1  ";
	 String url = "/hysupermarketjxcsys/admin/gqproduct.jsp?1=1";
...
border=0>
  ...
  <TR>
    <TD  height=24>【过期商品管理】</TD>
  	<TD  height=24 align="right" colspan="5"><a href="admin/gqproductadd.jsp" target=frmright>【新增过期商品】</a></TD>
  </TR>
  <TR align=center>
  ...
  <TR align=center>
    ...
    <a href="admin/gqproductedit.jsp?id=<%=map.get("id") %>">编辑</a>
    &nbsp;|&nbsp;
    <a href="admin/gqproduct.jsp?did=<%=map.get("id") %>">撤销</a>
    <%} %>
    </TD>
  </TR>
  <%} }%>
