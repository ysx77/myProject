...
<STYLE type=text/css>.STYLE1 {
  ...
  <body>
<form action="admin/customers.jsp?f=f" method="post">
	<%
	 String sql = "select * from suppliers where 1=1 and delstatus='0' and type='客户'";
	 String url = "/hysupermarketjxcsys/admin/customers.jsp?1=1";
...
border=0>
  <TBODY>
  <TR>
    <TD  height=24>【客户查询】</TD>
  </TR>
  <TR align=center>
    <TD class=forumrow  height=24 align="left">
    按客户名称查询:<input type="text" id="key" name="key" value="<%=key %>">
...
border=0>
  <TBODY>
  <TR>
    <TD  height=24>【客户管理】</TD>
  	<TD  height=24 align="right" colspan="4"><a href="admin/customeradd.jsp" target=frmright>【新增客户】</a></TD>
  </TR>
  <TR align=center>
    <TD class=forumrow  height=24>客户名称</TD>
  ...
  <TR align=center>
    ...
    <a href="admin/customeredit.jsp?id=<%=map.get("id") %>">编辑</a>
    &nbsp;|&nbsp;
    <a href="admin/customers.jsp?did=<%=map.get("id") %>">删除</a>
    </TD>
  </TR>
  <%} %>
  <TR align=center>
