...
<STYLE type=text/css>.STYLE1 {
  ...
  <body>
<form action="admin/xsdck.jsp?f=f" method="post">
	<%
	 String sql = "select * from xsdinfo where 1=1  ";
	 String url = "/hysupermarketjxcsys/admin/xsdck.jsp?1=1";
...
border=0>
  ...
  <TR align=center>
    ...
    <a href="/hysupermarketjxcsys/hysupermarketjxcsys?ac=xsdck&id=<%=map.get("id") %>">出货</a>
    <%} %>
    </TD>
  </TR>
  <%} %>
