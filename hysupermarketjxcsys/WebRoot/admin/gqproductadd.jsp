...
<STYLE type=text/css>.STYLE1 {
  ...
  <body>
    <BR>
  <form action="/hysupermarketjxcsys/hysupermarketjxcsys?ac=gqproductadd" name="f1" method="post" onsubmit="return ck()" >
<TABLE cellSpacing=1 cellPadding=3 width="95%" align=center bgColor=#6ab6b6 
border=0>
  <TBODY>
  <TR>
    <TD  height=24>【新增过期商品】</TD>
  ...
  <TR align=center>
    ...
    <TD class=forumrow  height=24 align="left">
    	<select id="pid" name="pid">
	    	...
	    	<option value="<%=keymap.get("id") %>"><%=keymap.get("pname") %></option>
	    	<%} %>
    	</select>
    </TD>
  </TR>
