...
<STYLE type=text/css>.STYLE1 {
  ...
  <body>
    <BR>
  <form action="/hysupermarketjxcsys/hysupermarketjxcsys?ac=protypeedit&id=<%=id %>" name="f1" method="post" onsubmit="return ck()" >
<TABLE cellSpacing=1 cellPadding=3 width="95%" align=center bgColor=#6ab6b6 
border=0>
  <TBODY>
  <TR>
    <TD  height=24>【编辑类别】</TD>
  ...
  <TR align=center>
    ...
    <TD class=forumrow  height=24 align="left"><input type="text" id="typename" name="typename" size="50"></TD>
  </TR>
  <TR align=center>
