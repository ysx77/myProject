...
<STYLE type=text/css>.STYLE1 {
  ...
  HashMap map = dao.select("select * from property where id="+id).get(0);
  %>
  <form action="/hysupermarketjxcsys/hysupermarketjxcsys?ac=propertyedit&id=<%=id %>" name="f1" method="post" onsubmit="return ck()" >
