...
<STYLE type=text/css>.STYLE1 {
  ...
  <form action="/hysupermarketjxcsys/hysupermarketjxcsys?ac=productadd" name="f1" method="post" onsubmit="return ck()">
  <input type="hidden" id="spsx" name="spsx" >
<TABLE cellSpacing=1 cellPadding=3 width="95%" align=center bgColor=#6ab6b6 border=0>
  ...
  <TR align=center>
    ...
    <TD class=forumrow  height=24 align="left" colspan="6"><input type="text" id="price" name="price" size="5" onkeyup='checkDecimal(this)'>元</TD>
  </TR>
  <TR align=center>
  	...
  	<TD class=forumrow  height=24 align="left" colspan="5">
  		<TABLE cellSpacing=1 cellPadding=3 width="50%" align=left bgColor=#6ab6b6 border=0>
  				...
  				<TR>
  					...
  					<td class=forumrow align=left><input type="text" id="sx" name="sx" onchange="getzhi()">
